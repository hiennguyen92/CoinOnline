...
class AddCoinController extends Component {
    static navigationOptions = ({ navigation }) => ({
      ...
      // header : null,
      headerTitle: navigation.state.params.id < 0 ? 'Add' : 'Edit',
                ...
                <ImageBackground style={styles.main} resizeMode='stretch' >
                    ...
                    <View style={styles.box}>
                        ...
                        <View style={styles.secondLayer} >
                            <Text style={styles.label}>Currency quantity (*)</Text>
                            <TextInput
                        ...
                        <View style={styles.thirdLayer}>
                            ...
                            <View style={styles.icons}>
                                {
                                    ['btc', 'ltc', 'etc', 'xmr'].map((item, index) => (
                        ...
                        <View style={styles.forthLayer}>
                            <Text style={styles.label}>Currency account</Text>
                            <TextInput
